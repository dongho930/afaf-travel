...
CONCEPTS: tuple[Concept, ...] = (
    ...
    # 소개문의 '반려동물 동반 가능'은 동물을 보러 가는 곳이 아닙니다 (카페가 걸렸음).
    Concept("동물", _re(r"동물|목장|아쿠아리움|곤충|새\s*보|물고기"),
            _re(r"동물|목장|아쿠아|곤충|조류|새공원|주렁주렁"),
            _re(r"동물원|(?<!반려)동물|목장|아쿠아리움|곤충|조류|먹이\s*주기"),
    ...
    Concept("쇼핑 장소", _re(r"쇼핑|시장|아울렛|백화점"),
            ...
            categories=frozenset({"쇼핑"})),
    # 소개문의 '힐링'은 카페·제과점·호수공원 소개에도 흔한 말이라 소개문에서는 보지 않습니다
    # (평가: '온천이나 휴양' 추천에 팔달제과·호수공원·박물관이 섞였음).
    Concept("온천·휴양", _re(r"온천|스파|힐링|휴양"),
            _re(r"온천|스파|휴양림|힐링|찜질"),
            _re(r"온천|스파|휴양림|찜질|족욕|치유의\s*숲"),
