...
class Settings(BaseSettings):
    ...
    # 그래서 200 + 300 + 500 = 1,000으로 잡았습니다. 처음엔 소개문 3분의 1과
    # 부가정보 전체가 비어 있어 그쪽에 더 줬는데, 2026-09 기준 세 캐시 모두
    # 거의 다 찼습니다 (편의시설 1,638 / 소개문 1,634 / 부가정보 1,615건).
    # 지금은 새로 생긴 장소와 기한이 지난 항목을 다시 받는 데 주로 쓰입니다.
