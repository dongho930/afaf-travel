...
**Verification depth scales with `asvs_level`** (see @C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
