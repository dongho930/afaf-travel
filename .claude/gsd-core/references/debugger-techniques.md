...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude
                  → checks C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/gsd-core
                  → writes to C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/gsd-core/hooks/
