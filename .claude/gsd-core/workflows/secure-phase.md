...
```
Agent(
  prompt="Read C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/gsd-core/templates/SECURITY.md`
