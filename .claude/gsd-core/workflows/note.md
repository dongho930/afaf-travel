...
- **Global scope**: `C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/notes/`)
...
2. Glob `C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/zakuv/Downloads/afaf-travel-planner/afaf-travel/.claude/notes/` — works in any directory
